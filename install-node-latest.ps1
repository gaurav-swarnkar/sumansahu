# Download and install Node.js v22.12.0 LTS from portable ZIP
...
Write-Host "Downloading Node.js v22.12.0 LTS..."
try {
    ...
    Write-Host "Node.js v22.12.0 installed to $extractPath"
