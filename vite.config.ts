...
function figmaSiteConfiguration(config: FigmaSiteConfiguration): Plugin {
  ...
  const title = config.title ?? "Design Products with Suman S."
  const description = config.description ?? 'Product Designer - Crafting meaningful digital experiences through thoughtful UX design'
