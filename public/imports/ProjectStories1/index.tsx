import svgPaths from "./svg-fhth98835c";
type ActionProps = {
  className?: string;
          ...
          <div className="relative size-[32px]">
            <div className="absolute left-0 size-[32px] top-0" data-name="arrow_forward">
              <svg className="absolute block inset-0 size-full" fill="none" height="32" preserveAspectRatio="none" viewBox="0 0 32 32" width="32">
                <g id="arrow_forward">
                  <mask height="32" id={isActive ? "mask0_0_36" : "mask0_0_74"} maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="32" x="0" y="0">
                    <rect fill="#D9D9D9" height="32" id="Bounding box" width="32" />
                  </mask>
                  <g mask={isActive ? "url(#mask0_0_36)" : "url(#mask0_0_74)"}>
...
function Frame10() {
  return (
    <div className="bg-white content-stretch flex gap-[12px] items-center px-[12px] py-[8px] relative rounded-[40px] shrink-0">
      <Frame9 />
      <p className="[word-break:break-word] font-['Poppins:SemiBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#6505e7] text-[20px] whitespace-nowrap">35%+ B2C Student Retention</p>
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="bg-white content-stretch flex gap-[12px] items-center px-[12px] py-[8px] relative rounded-[40px] shrink-0">
      <Frame13 />
      <p className="[word-break:break-word] font-['Poppins:SemiBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#6505e7] text-[20px] whitespace-nowrap">50%+ B2B Student Acquisition</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="absolute bg-[#7322ff] h-[1080px] left-[587px] overflow-clip top-0 w-[1333px]">
      <div className="absolute left-[104px] size-[1037px] top-[548px]">
        <div className="absolute inset-[-38.57%]">
          <svg className="block size-full" fill="none" height="1837" preserveAspectRatio="none" viewBox="0 0 1837 1837" width="1837">
            <g filter="url(#filter0_f_0_79)" id="Ellipse 6">
              <circle cx="918.5" cy="918.5" fill="#322347" r="518.5" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="1837" id="filter0_f_0_79" width="1837" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_0_79" stdDeviation="200" />
              </filter>
            </defs>
          </svg>
        </div>
      ...
      <div className="absolute left-[754px] size-[1247px] top-[-312px]">
        <div className="absolute inset-[-64.15%]">
          <svg className="block size-full" fill="none" height="2847" preserveAspectRatio="none" viewBox="0 0 2847 2847" width="2847">
            <g filter="url(#filter0_f_0_39)" id="Ellipse 7">
              <circle cx="1423.5" cy="1423.5" fill="black" fillOpacity="0.5" r="623.5" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="2847" id="filter0_f_0_39" width="2847" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_0_39" stdDeviation="400" />
              </filter>
            </defs>
          </svg>
        </div>
...
export default function ProjectStories() {
  return (
    <div className="bg-[#f8f1ff] relative size-full" data-name="Project Stories 1">
      ...
      <div className="absolute h-[917px] left-[531px] top-[54px] w-[112px]">
        <div className="absolute inset-[-43.62%_-357.14%]">
          <svg className="block size-full" fill="none" height="1717" preserveAspectRatio="none" viewBox="0 0 912 1717" width="912">
            <g filter="url(#filter0_f_0_71)" id="Ellipse 9">
              <ellipse cx="456" cy="858.5" fill="#7322FF" rx="56" ry="458.5" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="1717" id="filter0_f_0_71" width="912" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_0_71" stdDeviation="200" />
              </filter>
            </defs>
          </svg>
        </div>
