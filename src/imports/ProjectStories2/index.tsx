import svgPaths from "./svg-hmec6esqma";
type ActionProps = {
  className?: string;
          ...
          <div className="relative size-[32px]">
            <div className="absolute left-0 size-[32px] top-0" data-name="arrow_forward">
              <svg className="absolute block inset-0 size-full" fill="none" height="32" preserveAspectRatio="none" viewBox="0 0 32 32" width="32">
                <g id="arrow_forward">
                  <mask height="32" id={isActive ? "mask0_0_32" : "mask0_0_40"} maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="32" x="0" y="0">
                    <rect fill="#D9D9D9" height="32" id="Bounding box" width="32" />
                  </mask>
                  <g mask={isActive ? "url(#mask0_0_32)" : "url(#mask0_0_40)"}>
      ...
      <div className={`-translate-x-1/2 -translate-y-1/2 absolute left-1/2 top-1/2 ${isActive ? "flex items-center justify-center size-[45.255px]" : "size-[32px]"}`}>
        {property1 === "default" && (
          <div className="absolute left-0 size-[32px] top-0" data-name="arrow_forward">
            <svg className="absolute block inset-0 size-full" fill="none" height="32" preserveAspectRatio="none" viewBox="0 0 32 32" width="32">
              <g id="arrow_forward">
                <mask height="32" id="mask0_0_70" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="32" x="0" y="0">
                  <rect fill="#D9D9D9" height="32" id="Bounding box" width="32" />
                </mask>
          ...
          <div className="-rotate-45 flex-none">
            <div className="relative size-[32px]">
              <div className="absolute left-0 size-[32px] top-0" data-name="arrow_forward">
                <svg className="absolute block inset-0 size-full" fill="none" height="32" preserveAspectRatio="none" viewBox="0 0 32 32" width="32">
                  <g id="arrow_forward">
                    <mask height="32" id="mask0_0_32" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="32" x="0" y="0">
                      <rect fill="#D9D9D9" height="32" id="Bounding box" width="32" />
                    </mask>
...
function Group() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <p className="[word-break:break-word] col-1 font-['Poppins:SemiBold',sans-serif] leading-[normal] ml-0 mt-0 not-italic relative row-1 text-[64px] text-white w-[729px]">Flash Card Engagement Spike</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[28px]" data-name="flash_on">
      <svg className="absolute block inset-0 size-full" fill="none" height="28" preserveAspectRatio="none" viewBox="0 0 28 28" width="28">
        <g id="flash_on">
          <mask height="28" id="mask0_0_65" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="28" x="0" y="0">
...
function Frame9() {
  return (
    <div className="bg-white content-stretch flex gap-[12px] items-center px-[12px] py-[8px] relative rounded-[40px] shrink-0">
      <Frame8 />
      <p className="[word-break:break-word] font-['Poppins:SemiBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#6505e7] text-[20px] whitespace-pre">{`70% With 3+ min more engagement time  `}</p>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="absolute bg-[#3f0390] h-[1080px] overflow-clip right-0 top-0 w-[1333px]">
      <div className="absolute right-[-602px] size-[1037px] top-[138px]">
        <div className="absolute inset-[-38.57%]">
          <svg className="block size-full" fill="none" height="1837" preserveAspectRatio="none" viewBox="0 0 1837 1837" width="1837">
            <g filter="url(#filter0_f_0_68)" id="Ellipse 8">
              <circle cx="918.5" cy="918.5" fill="#884BDB" fillOpacity="0.5" r="518.5" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="1837" id="filter0_f_0_68" width="1837" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_0_68" stdDeviation="200" />
              </filter>
            </defs>
          </svg>
        </div>
      </div>
      <div className="absolute flex h-[381.329px] items-center justify-center left-[-52px] top-[649px] w-[568.717px]">
        <div className="flex-none rotate-[0.34deg] skew-x-[-0.03deg]">
          <div className="bg-[#18033b] h-[378.001px] relative rounded-[40px] w-[566.322px]" />
        </div>
      </div>
      <div className="absolute flex h-[381.482px] items-center justify-center left-[783.28px] top-[649px] w-[594.544px]">
        <div className="flex-none rotate-[0.34deg] skew-x-[-0.03deg]">
          <div className="bg-[rgba(24,3,59,0.8)] h-[378.001px] relative rounded-[40px] w-[592.149px]" />
        </div>
      </div>
      <Frame10 />
      <div className="absolute flex h-[413.947px] items-center justify-center left-[308.44px] top-[540px] w-[777.802px]">
        <div className="flex-none rotate-[0.34deg] skew-x-[-0.03deg]">
          <div className="bg-white h-[409.388px] relative rounded-[40px] w-[775.211px]" />
        </div>
      </div>
...
function Frame1() {
  return (
    <div className="content-stretch flex gap-[12px] items-end relative shrink-0 w-full">
      <p className="[word-break:break-word] font-['Poppins:SemiBold',sans-serif] leading-none not-italic relative shrink-0 text-[#18033b] text-[100px] whitespace-nowrap">Delight</p>
      <Frame />
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col gap-[64px] items-start relative shrink-0 w-full">
      ...
      <div className="relative shrink-0" data-name="action 2">
        <div className="content-stretch flex flex-col gap-[12px] items-start relative size-full">
          <p className="[word-break:break-word] font-['Poppins:SemiBold',sans-serif] leading-none not-italic relative shrink-0 text-[#18033b] text-[48px] w-full">UI FOR</p>
          <Frame1 />
        </div>
      </div>
...
export default function ProjectStories() {
  return (
    <div className="bg-[#f8f1ff] relative size-full" data-name="Project Stories 2">
      <div className="absolute left-[-111px] size-[543px] top-[-117px]">
        <div className="absolute inset-[-18.42%]">
          <svg className="block size-full" fill="none" height="743" preserveAspectRatio="none" viewBox="0 0 743 743" width="743">
            <g filter="url(#filter0_f_0_64)" id="Ellipse 1" opacity="0.2">
              <circle cx="371.5" cy="371.5" fill="#F0FF64" r="271.5" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="743" id="filter0_f_0_64" width="743" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_0_64" stdDeviation="50" />
              </filter>
            </defs>
          </svg>
        </div>
      ...
      <div className="absolute left-[30px] size-[613px] top-[70px]">
        <div className="absolute inset-[-32.63%]">
          <svg className="block size-full" fill="none" height="1013" preserveAspectRatio="none" viewBox="0 0 1013 1013" width="1013">
            <g filter="url(#filter0_f_0_69)" id="Ellipse 4">
              <circle cx="506.5" cy="506.5" fill="#FFFCF4" r="306.5" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="1013" id="filter0_f_0_69" width="1013" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_0_69" stdDeviation="100" />
              </filter>
            </defs>
          </svg>
        </div>
      ...
      <Frame4 />
      <Frame3 />
      <div className="absolute h-[917px] left-[531px] top-[54px] w-[112px]">
        <div className="absolute inset-[-43.62%_-357.14%]">
          <svg className="block size-full" fill="none" height="1717" preserveAspectRatio="none" viewBox="0 0 912 1717" width="912">
            <g filter="url(#filter0_f_0_37)" id="Ellipse 9">
              <ellipse cx="456" cy="858.5" fill="#7322FF" rx="56" ry="458.5" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="1717" id="filter0_f_0_37" width="912" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_0_37" stdDeviation="200" />
              </filter>
            </defs>
          </svg>
        </div>
